...
@section('main-content')
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Data Request Delete</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item">Request Delete</li>
                    <li class="breadcrumb-item active">Data Request Delete</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 d-flex justify-content-between align-items-center">
                                    <h5 class="card-title">Data Request Delete</h5>
                                    ...
                                    @forelse ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @endif
                                                <td>
                                                    <a href="{{ route('siswa.reqdelete.show', $item->id) }}"
